    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('client', 'Client'), ('vendor', 'Vendor'), ('admin', 'Admin')], max_length=20, null=True)),
                ('status', models.CharField(blank=True, choices=[('D', 'deleted'), ('I', 'inactive'), ('A', 'active'), ('U', 'unverified')], max_length=20, null=True)),
